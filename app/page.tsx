                                            ...
                                            <DialogContent>
                                                ...
                                                <DialogDescription>
                                                    <div className="flex flex-col gap-2">
                                                        <div className="commodity-info flex gap-2 items-center">
                                                            商品名称:
                                                            <div className='flex gap-2 items-center'>

                                                                <Image className='cover col-span-1 h-full w-auto'
                                                                       src={WebSiteIcon[commodity.cover] || WebSiteIcon.TK}
                                                                       alt='icon' width={32} height={32}/>
                                                                <span>{commodity.name}</span>
                                                            </div>
                                                        </div>
                                                        <div className="commodity-price">价格: <span
                                                            className='text-red-400 font-black'>￥{commodity.price}</span>
                                                        </div>
                                                        <div className="commodity-stock">库存：<span
                                                            className='text-blue-400 font-black'>{commodity.stock}</span>
                                                        </div>
                                                        <div className="commodity-action flex gap-2">
                                                            <div
                                                                className="action col-span-4  md:col-span-1 flex gap-2 items-center bg-blue-500 hover:bg-blue-700 cursor-pointer px-2 rounded-2xl text-white transition-all hover:shadow-2xl">
                                                                <BsCartPlusFill/>
                                                                <span>购买</span>
